 ...
 */
	...
	function updateJvm(jvmInfo, json) {
		...
		var html = "<div class='row'>"
				...
				+ "<tr><td><h5>PS Mark Sweep Runs</h5></td><td>" + jvm['jvm.gc.PS-MarkSweep.count'].value + "</td></tr>"
				+ "<tr><td><h5>PS Mark Sweep Time</h5></td><td>" + jvm['jvm.gc.PS-MarkSweep.time'].value + "</td></tr>"
				+ "<tr><td><h5>GC Scavenge Runs</h5></td><td>" + jvm['jvm.gc.PS-Scavenge.count'].value + "</td></tr>"
				+ "<tr><td><h5>GC Scavenge Time</h5></td><td>" + jvm['jvm.gc.PS-Scavenge.time'].value + "</td></tr>"
				+ "</table></div>"
